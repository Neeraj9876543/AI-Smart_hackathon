...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      // If login fails, navigate to landing page
      navigate('/');
    }
    setLoading(false);
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-16">
        ...
        >
          <div className="w-full max-w-xl">
            <DotLottieReact
              src="https://lottie.host/858c635e-b7e9-4fa4-b9de-e2cd2926f990/BgPAIARvyo.lottie"
              loop
              autoplay
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-16">
        ...
        >
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="font-display font-bold text-xl text-foreground">ScholarGraph</span>
          </div>
          ...
          <p className="text-center text-xs text-muted-foreground mt-8 lg:hidden">
            Demo: Use <strong>student@demo.com</strong> as email, <strong>password123</strong> as password.
          </p>
        </motion.div>
      </div>
    </div>
